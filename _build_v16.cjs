...
console.log(modified === c ? 'WARN: getSlotFen' : 'OK: getSlotFen');

// === FIX 2: buildGrid - show all times, mark booked/closed, skip last row, CHECK bookedSet ===
...
console.log(modified === c ? 'WARN: buildGrid' : 'OK: buildGrid (+bookedSet check)');
...
console.log(modified === c ? 'WARN: applySchedule' : 'OK: applySchedule');
...
console.log(modified === c ? 'WARN: toggleCell' : 'OK: toggleCell');
...
console.log(modified === c ? 'WARN: refreshPriceClasses' : 'OK: refreshPriceClasses');

// === FIX 6: Add booked CSS ===
...
console.log(modified === c ? 'WARN: bookedCSS' : 'OK: bookedCSS');

// === FIX 7: Update version ===
modified = modified.replace(/v12\.0/g, 'v16.0');

fs.writeFileSync('d:/Documents/code/badmintonbooker_solo/worker_v16.js', modified);
console.log('Created worker_v16.js, length:', modified.length);