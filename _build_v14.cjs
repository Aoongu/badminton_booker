...
console.log(modified === c ? 'WARN: buildGrid replace failed' : 'OK: buildGrid now shows all times, marks booked/closed');
...
modified = modified.replace(/v12\.0/g, 'v14.0');

fs.writeFileSync('d:/Documents/code/badmintonbooker_solo/worker_v14.js', modified);
console.log('Created worker_v14.js, length:', modified.length);